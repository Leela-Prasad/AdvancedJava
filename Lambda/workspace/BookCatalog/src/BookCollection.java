...
public class BookCollection {
	...
	public List<Book> findBooksV2(Predicate<Book> searchCriteria) {
	...
	public Map<Integer, String> findBookTitles(Predicate<Book> searchCriteria) {
		return books.stream().filter(searchCriteria).collect(Collectors.toMap(b -> b.getId(), b -> b.getTitle()));
	}
	
	public Long getNoOfMatchedBooks(Predicate<Book> searchCriteria) {
